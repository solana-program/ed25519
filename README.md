...
| `sol_curve_validate_point`  | Selected malformed-input checks                                                                  |
| `sol_curve_multiscalar_mul` | Fixed two-term wrapper for individual verification                                                |
...
The MSM checks `A` and `S` together and reports the same `InvalidEncoding`
error for malformed scalar or point encodings.
...
| ------------- | --------------------------------------------------------------- | ------------------------------------------- |
| `verify`      | `Ed25519Verifier`, criteria and errors                         | `solana-curve25519`, `solana-sha512-hasher` |
